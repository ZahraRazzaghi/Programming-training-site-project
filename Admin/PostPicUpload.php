<?php
$file = $_FILES["postImg"]["name"];//file
$tmp_name = $_FILES["postImg"]["tmp_name"];//Curent dir
$directory = 'images/PostPics/';// save pics on this directory with session name
...
if ( $_FILES["postImg"]["size"] > 2000000 ) {
