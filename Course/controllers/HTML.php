...
if(isset($_POST['start-learning'])){
    if(!isset($_SESSION['loggedin'])){
        ...
        if ($rows>0){
            header('Location: ../Courses/HTML/HTML-1.php');
        }else{
...
<div class="wrapper pageLayout container-fluid">
    <div class="content">
        <div class="block">
            ...
            <p>
                HTML یک زبان نشانه گذاری است ، به اين معنی که بخش های مختلف توسط اجزايی به نام تگ از هم جدا شده ،
                که هر کدام دارای کاربرد و خواص مربوط خود هستند .
