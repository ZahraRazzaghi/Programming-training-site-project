...
<div class="content">
    ...
    if(isset($_GET['replyComment'])){
        $id = mysqli_real_escape_string($db, $_GET['replyComment']);
    ...
    echo '<form action="" method="POST">
        ...
        <textarea  id="trumbowyg-demo" class="textBox" name="contentReply"></textarea><br>
    ...
    if(isset($_POST['sendReply'])){
        ...
        if ($run) {
            ...
            echo "<script> window.location.replace('Comments.php') </script>";
        } else {
